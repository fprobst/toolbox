...
/**
 * Ersatz f�r den aktuellen Wait Dialog der eher schlecht als recht funktioniert
 */
public final class WaitDialog
{
    /** Executor f�hr die Runnables aus */
    ...
    /** Der Dialog der ggf. w�hrend der Ausf�hrung angezeigt wird */
    private InnerDialog m_Dialog = null;

    /**
     * Keine �ffentlichen Instanzen erlaubt
     */
    private WaitDialog()
    {
        // Macht nichts
    ...
    /**
     * Gib dem Wait Dialog etwas zu tun. W�hrend der Ausf�hrung des �bergebenen Tasks wird der �bergebene Text (key aus
    ...
    /**
     * Wartet auf das Ergebnis des �bergebenen Tasks. W�hrend der Ausf�hrung des �bergebenen Tasks wird der �bergebene
    ...
    /**
     * F�gt dem Executor einen neuen Job hinzu. Der Text (aus einem ResourceBundle?) wird w�hrend der Ausf�hrung des
     * Jobs angezeigt
     *
     * @param message
     * @param task
    ...
    /**
     * Liefert das Ergebnis des �bergebenen Callables zur�ck. W�hrend der Ausf�hrung wird der �bergebene Text (aus
    ...
    /**
     * Ein Runnable wurde beendet - pr�fe den Counter ob noch weitere Jobs offen sind. Wenn nicht, wird der Dialog
     * ausgeblendet
     */
    ...
    /**
     * Startet die Ausf�hrung eines Tasks. Falls der Dialog nicht angezeigt wird, wird er eingeblendet
     */
    ...
    /**
     * Inneres Callable das im Vergleich zum Runnable einen Wert zur�ckliefern kann. W�hrend der Ausf�hrung wird der
     * angegebene Text angezeigt.
     */
    class InnerCallable<V> implements Callable<V>
    {
        /** Meldung f�r die Progressbar */
        private String m_Message;

        /** Task der ausgef�hrt werden soll */
        private Callable<V> m_Callable;

        /**
         * Konstruktor �bergibt die notwendigen Felder Meldung und Task
         *
         * @param message
         * @param task
         */
    ...
    /**
     * Spezielles Runnable das zus�tzlich einen Text speichert der angezeigt werden kann
     */
